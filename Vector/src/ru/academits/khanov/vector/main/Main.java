...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Умножение вектора 3 на скаляр " + vector3.multiplyByScalar(10.1111));

        System.out.println("Вектор 3 разворот: " + vector3.turn());

        System.out.println("Вектор 1 длина: " + vector1.getLength());

        System.out.println("Вектор 1 + 3 (static): " + Vector.sum(vector1, vector3));

        System.out.println("Вектор 1 - 3 (static): " + Vector.subtract(vector1, vector3));

        System.out.println("Вектор 1 * 2 (static): " + Vector.getVectorsProduct(vector1, vector2));
